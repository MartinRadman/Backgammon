...
public class Platno extends JPanel implements MouseListener, MouseMotionListener, KeyListener{
	...
	public boolean igralec_na_potezi = true;
	...
	protected void paintComponent(Graphics g) {
		...
		if (aktivna_igra) {
	         ...
	         * V primeru, da bo Ä‡etonov več kot 5 bomo vse nabasali v en kup, nato pa zraven kupa zapisali koliko žetonov sestavja ta stolp 
	         *  
	         */
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (osnovni_meni) {
			...
			//ker se pozicija menija glede na igra_po_meri spremeni, se tudi zaznavna polja spremenijo
			if (igra_po_meri) {
	...
	public void poteza(int aktivna, int nova) {
		...
		korak[1] = (nova == 0 || nova == 25) ? 24 : 23 - (nova - 1);
		
		int a = razlika(aktivna, nova);
		boolean validen = false;
			
		for (int[] koraki : igra.trenutne_validne()) {
			if (Arrays.equals(korak, koraki)) validen = true;;
		}
	...
	public void novaIgra(String igralec1, String igralec2, VrstaIgralca vrsta1, VrstaIgralca vrsta2) {
		okno_igra = new Okno(igralec1, igralec2, vrsta1, vrsta2);
		okno_igra.pack();
